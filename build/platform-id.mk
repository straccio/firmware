...
ifeq ("$(PLATFORM_ID)","6144")
PLATFORM=nucleo-f429zi
STM32_DEVICE=STM32F4XX
PLATFORM_NAME=nucleo-f429zi
PLATFORM_MCU=STM32F429ZI
PLATFORM_NET=STM32F4xx
PRODUCT_DESC=Nucleo 144 F429ZI
# eventually want to generate the PID from the base + product ID
USBD_VID_SPARK=0x2B04
USBD_PID_DFU=0xD006
USBD_PID_CDC=0xC006
#PLATFORM_DYNALIB_MODULES=nucleo-f429zi
DEFAULT_PRODUCT_ID=6144
#PLATFORM_STM32_STDPERIPH_EXCLUDE=y
endif
